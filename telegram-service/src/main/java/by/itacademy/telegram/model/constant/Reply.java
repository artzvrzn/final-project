...
public enum Reply {
    ...
    GREET("Привет привет"),
    OPERATION_CHOICE_MADE("Операция выбрана"),
    ACCOUNT_CHOICE_MADE("Аккаунт выбран"),
    ...
    ACCOUNT_TYPE("Выберите тип аккаунта из предложенных"),
    ACCOUNT_WRONG_TYPE("Неверный тип аккаунта!"),
    ACCOUNT_CURRENCY("Выберите валюту аккаунта из предложенных"),
    ...
    ACCOUNT_UPDATE_TYPE("Выберите новый тип из предложенных (\"/\" чтобы оставить прежним)"),
